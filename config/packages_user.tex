...
%--------------------------------------
\usepackage{pifont} % used for circle numbers
\usepackage{listings}
\usepackage{config/lstlangs/go/lang}
\usepackage{config/lstlangs/go/style}
...
\usepackage[
    ...
    hyperref=true,
    backend=biber,
    style=numeric,%chicago-authordate
    sorting=nty,
]{biblatex} % Nice MLA bibliography
